 ...
 *   https://datatables.net/download/#dt/dt-2.0.3/b-3.0.1/fh-4.0.1/r-3.0.1
 *
 * Included libraries:
 *   DataTables 2.0.3, Buttons 3.0.1, FixedHeader 4.0.1, Responsive 3.0.1
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.0.3/b-3.0.1/fh-4.0.1/r-3.0.1",
